    ...
    <div className="profileEdit">
      ...
      <div className="profileEditInputs">
        ...
        <input
          onChange={getInput}
          className="common-input"
          placeholder={currentUser.country ? currentUser.country : "Country"}
          name="country"
        ...
        <input
          onChange={getInput}
          className="common-input"
          placeholder={currentUser.industry ? currentUser.industry : "Industry"}
          name="industry"
        ...
        <input
          onChange={getInput}
          className="common-input"
          placeholder={currentUser.skills ? currentUser.skills : "Skill"}
          name="skills"
        ...
        <textarea
          ...
          onChange={getInput}
          placeholder={currentUser.aboutme ? currentUser.aboutme : "About Me"}
          name="aboutme"
